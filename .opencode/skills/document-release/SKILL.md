...
- Auto-fix minor voice adjustments. Use the question tool if a rewrite would alter meaning.
...
5. Flag any contradictions between documents. Auto-fix clear factual inconsistencies (e.g., a
   version mismatch). Use the question tool for narrative contradictions.
...
2. **Items needing description updates:** If a TODO references files or components that were
   significantly changed, its description may be stale. Use the question tool to confirm whether
...
3. **If VERSION was NOT bumped:** Use the question tool:
...
4. **If VERSION was already bumped:** Do NOT skip silently. Instead, check whether the bump
   ...
   d. **If there are significant uncovered changes:** Use the question tool explaining what the
