...
export const COMMAND_DESCRIPTIONS: Record<string, { category: string; description: string; usage?: string }> = {
  ...
  eval: {
    category: "Inspection",
    description: "Run JavaScript from file and return result as string (path must be under /tmp or cwd)",
    usage: "eval <file>",
  },
  ...
  storage: {
    category: "Inspection",
    description: "Read all localStorage + sessionStorage as JSON, or set <key> <value> to write localStorage",
  ...
  device: {
    category: "Interaction",
    description: "Set mobile device preset (--list shows available devices)",
    usage: "device <name|--list>",
  },
  block: {
    category: "Interaction",
    description: "Block requests matching patterns (comma-separated)",
    usage: "block <pattern1,pattern2,...>",
  },
  mock: {
    category: "Interaction",
    description: "Mock response for URL pattern",
    usage: "mock <url-pattern> <response>",
  },
  unmock: { category: "Interaction", description: "Clear all request mocks and blocks" },
  "cookies-save": {
    category: "Interaction",
    description: "Save cookies to file",
    usage: "cookies-save [path]",
  },
  "cookies-load": {
    category: "Interaction",
    description: "Load cookies from file",
    usage: "cookies-load [path]",
  },
  "dialog-accept": {
    category: "Interaction",
