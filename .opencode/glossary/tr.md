...
- `OpenAiCode` (preserve casing in prose, docs, and UI copy)
...
- Keep product naming consistent: `OpenAiCode` in prose, `opencode` only for exact technical identifiers
...
- Avoid changing `opencode` to `OpenAiCode` inside commands, URLs, package names, or code literals
