...
# Do-Not-Translate Terms (OpenAiCode Docs)
...
OpenAiCode config
OpenAiCode Config
OpenAiCode TUI with the opencode theme
OpenAiCode Web - Active Session
OpenAiCode Web - New Session
OpenAiCode Web - See Servers
OpenAiCode Zen
OpenAiCode-Obsidian
...
## OpenAiCode CLI commands (as shown in docs)
