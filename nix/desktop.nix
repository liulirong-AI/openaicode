...
rustPlatform.buildRustPackage (finalAttrs: {
  ...
  postFixup = lib.optionalString stdenv.hostPlatform.isLinux ''
    mv $out/bin/OpenAiCode $out/bin/opencode-desktop
    sed -i 's|^Exec=OpenAiCode$|Exec=opencode-desktop|' $out/share/applications/OpenAiCode.desktop
  '';

  meta = {
    description = "OpenAiCode Desktop App";
