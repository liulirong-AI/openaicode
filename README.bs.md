...
<p align="center">OpenAiCode je open source AI agent za programiranje.</p>
<p align="center">
...
OpenAiCode je dostupan i kao desktop aplikacija. Preuzmi je direktno sa [stranice izdanja](https://github.com/liulirong-AI/openaicode/releases) ili sa [opencode.ai/download](https://opencode.ai/download).
...
OpenAiCode uključuje dva ugrađena agenta između kojih možeš prebacivati tasterom `Tab`.
...
Za više informacija o konfiguraciji OpenAiCode-a, [**pogledaj dokumentaciju**](https://opencode.ai/docs).

### Doprinosi

Ako želiš doprinositi OpenAiCode-u, pročitaj [upute za doprinošenje](./CONTRIBUTING.md) prije slanja pull requesta.

### Gradnja na OpenAiCode-u

Ako radiš na projektu koji je povezan s OpenAiCode-om i koristi "opencode" kao dio naziva, npr. "opencode-dashboard" ili "opencode-mobile", dodaj napomenu u svoj README da projekat nije napravio OpenAiCode tim i da nije povezan s nama.
...
- 100% open source
- Nije vezan za jednog provajdera. Iako preporučujemo modele koje nudimo kroz [OpenAiCode Zen](https://opencode.ai/zen), OpenAiCode možeš koristiti s Claude, OpenAI, Google ili čak lokalnim modelima. Kako modeli napreduju, razlike među njima će se smanjivati, a cijene padati, zato je nezavisnost od provajdera važna.
- LSP podrška odmah po instalaciji
- Fokus na TUI. OpenAiCode grade neovim korisnici i kreatori [terminal.shop](https://terminal.shop); pomjeraćemo granice onoga što je moguće u terminalu.
- Klijent/server arhitektura. To, recimo, omogućava da OpenAiCode radi na tvom računaru dok ga daljinski koristiš iz mobilne aplikacije, što znači da je TUI frontend samo jedan od mogućih klijenata.
