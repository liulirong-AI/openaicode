...
export function createMenu(deps: Deps) {
  ...
  const template: Electron.MenuItemConstructorOptions[] = [
    ...
    },
    {
      label: "Help",
      submenu: [
        { label: "OpenAiCode Documentation", click: () => shell.openExternal("https://opencode.ai/docs") },
        ...
        { type: "separator" },
        {
          ...
          click: () =>
            shell.openExternal("https://github.com/liulirong-AI/openaicode/issues/new?template=feature_request.yml"),
        },
        {
          label: "Report a Bug",
          click: () => shell.openExternal("https://github.com/liulirong-AI/openaicode/issues/new?template=bug_report.yml"),
        },
      ],
    },
  ]
