export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de OpenAiCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de OpenAiCode. ¿Quieres instalarla y reiniciar?",
