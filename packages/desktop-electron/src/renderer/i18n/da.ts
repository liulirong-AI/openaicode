export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af OpenAiCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af OpenAiCode er blevet downloadet. Vil du installere den og genstarte?",
