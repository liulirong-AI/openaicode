export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of OpenAiCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of OpenAiCode has been downloaded, would you like to install it and relaunch?",
