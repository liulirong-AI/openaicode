export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von OpenAiCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von OpenAiCode wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
