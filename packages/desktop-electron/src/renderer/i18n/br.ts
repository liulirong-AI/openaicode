export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do OpenAiCode",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do OpenAiCode foi baixada. Você gostaria de instalá-la e reiniciar?",
