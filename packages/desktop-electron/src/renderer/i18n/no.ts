export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av OpenAiCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av OpenAiCode er lastet ned. Vil du installere den og starte på nytt?",
