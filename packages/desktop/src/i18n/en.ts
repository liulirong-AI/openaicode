export const dict = {
  ...
  "desktop.menu.help.documentation": "OpenAiCode Documentation",
  ...
  "desktop.cli.error.sidecarMissing": "OpenAiCode CLI binary is missing. Try reinstalling the desktop app.",
