export const dict = {
  ...
  "desktop.menu.help.documentation": "OpenAiCode Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "OpenAiCode CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
