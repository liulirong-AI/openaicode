export const dict = {
  ...
  "desktop.menu.help.documentation": "OpenAiCode Dokumentation",
  ...
  "desktop.cli.error.sidecarMissing": "OpenAiCode CLI-binærfil mangler. Prøv at geninstallere desktop-appen.",
