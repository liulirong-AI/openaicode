  ...
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all OpenAiCode sessions, sorted by most recently updated.",
      ...
      async (c) => {
        ...
        const normalizedDir = query.directory ? Filesystem.resolve(query.directory) : undefined
    ...
    .get(
      ...
      describeRoute({
        summary: "Get session",
        description: "Retrieve detailed information about a specific OpenAiCode session.",
        tags: ["Session"],
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Create a new OpenAiCode session for interacting with AI assistants and managing conversations.",
