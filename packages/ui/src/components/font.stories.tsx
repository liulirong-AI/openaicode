...
const docs = `### Overview
Loads OpenAiCode typography assets and mono nerd fonts.
...
export const Basic = {
  render: () => (
    <div style={{ display: "grid", gap: "8px" }}>
      <mod.Font />
      <div style={{ "font-family": "var(--font-family-sans)" }}>OpenAiCode Sans Sample</div>
      <div style={{ "font-family": "var(--font-family-mono)" }}>OpenAiCode Mono Sample</div>
    </div>
  ),
}
