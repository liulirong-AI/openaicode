---
title: Ecosystem
description: Projects and integrations built with OpenAiCode.
---

A collection of community projects built on OpenAiCode.

:::note
Want to add your OpenAiCode related project to this list? Submit a PR.
:::
...
| Name                                                                                               | Description                                                                                       |
| -------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Automatically run OpenAiCode sessions in isolated Daytona sandboxes with git sync and live previews |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Track OpenAiCode usage with Wakatime                                                                |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Desktop notifications and sound alerts for OpenAiCode sessions                                      |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | AI-powered automatic Zellij session naming based on OpenAiCode context                              |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Allow OpenAiCode agents to lazy load prompts on demand with skill discovery and injection           |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Native OS notifications for OpenAiCode – know when tasks complete                                   |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Zero-friction git worktrees for OpenAiCode                                                          |
...
| Name                                                                                       | Description                                                      |
| ------------------------------------------------------------------------------------------ | ---------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Discord bot to control OpenAiCode sessions, built on the SDK       |
...
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Template for building OpenAiCode plugins                           |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Neovim frontend for opencode - a terminal-based AI coding agent  |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Vercel AI SDK provider for using OpenAiCode via @opencode-ai/sdk   |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Web / Desktop App and VS Code Extension for OpenAiCode             |
| [OpenAiCode-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Obsidian plugin that embeds OpenAiCode in Obsidian's UI            |
| [OpenWork](https://github.com/different-ai/openwork)                                       | An open-source alternative to Claude Cowork, powered by OpenAiCode |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | OpenAiCode extension manager with portable, isolated profiles.     |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Desktop, Web, Mobile and Remote Client App for OpenAiCode          |
