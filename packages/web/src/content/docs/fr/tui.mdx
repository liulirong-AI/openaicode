---
title: TUI
description: Utilisation de l’interface utilisateur du terminal OpenAiCode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

OpenAiCode fournit une interface de terminal interactif ou TUI pour travailler sur vos projets avec un LLM.

L’exécution de OpenAiCode démarre le TUI pour le répertoire actuel.
...
Lorsque vous utilisez le OpenAiCode TUI, vous pouvez taper `/` suivi d'un nom de commande pour exécuter rapidement des actions. Par exemple:
...
Ajoutez un fournisseur à OpenAiCode. Vous permet de sélectionner parmi les fournisseurs disponibles et d’ajouter leurs clés API.
...
Quittez OpenAiCode. *Alias* : `/quit`, `/q`
