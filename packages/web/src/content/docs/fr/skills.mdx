...
Les compétences d'agent permettent à OpenAiCode de découvrir des instructions réutilisables à partir de votre dépôt ou de votre répertoire personnel.
...
OpenAiCode recherche ces emplacements :
...
Pour les chemins locaux du projet, OpenAiCode remonte de votre répertoire de travail actuel jusqu'à ce qu'il atteigne l'arbre de travail git.
...
OpenAiCode répertorie les compétences disponibles dans la description de l'outil `skill`.
