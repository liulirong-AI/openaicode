---
title: Serveurs LSP
description: OpenAiCode s'intègre à vos serveurs LSP.
---

OpenAiCode s'intègre via le protocole LSP (Language Server Protocol) pour aider le LLM à interagir avec votre base de code. Il utilise des diagnostics pour fournir des commentaires au LLM.

---

## Serveurs intégrés

OpenAiCode est livré avec plusieurs serveurs LSP intégrés pour les langages populaires :
