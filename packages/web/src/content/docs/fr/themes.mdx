...
Avec OpenAiCode, vous pouvez choisir parmi plusieurs thèmes intégrés, utiliser un thème qui s'adapte au thème de votre terminal ou définir votre propre thème personnalisé.

Par défaut, OpenAiCode utilise notre propre thème `opencode`.
...
OpenAiCode est livré avec plusieurs thèmes intégrés.
...
- Vous souhaitez que OpenAiCode corresponde à l'apparence de leur terminal
...
OpenAiCode prend en charge un système de thèmes flexible basé sur JSON qui permet aux utilisateurs de créer et de personnaliser facilement des thèmes.
