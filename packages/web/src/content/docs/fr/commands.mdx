...
Vous pouvez ajouter des commandes personnalisées via la configuration OpenAiCode ou en créant des fichiers markdown dans le répertoire `commands/`.

---

### JSON

Utilisez l'option `command` dans votre OpenAiCode [config](/docs/config) :
