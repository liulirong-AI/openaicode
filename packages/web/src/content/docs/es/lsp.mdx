...
description: OpenAiCode se integra con sus servidores LSP.
---

OpenAiCode se integra con su protocolo de servidor de idiomas (LSP) para ayudar a LLM a interactuar con su código base. Utiliza diagnósticos para proporcionar retroalimentación al LLM.

---

## Incorporados

OpenAiCode viene con varios servidores LSP integrados para idiomas populares:
