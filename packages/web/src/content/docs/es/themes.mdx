...
Con OpenAiCode puede seleccionar uno de varios temas integrados, usar un tema que se adapte al tema de su terminal o definir su propio tema personalizado.

De forma predeterminada, OpenAiCode usa nuestro propio tema `opencode`.
...
OpenAiCode viene con varios temas integrados.
...
- Quiere que OpenAiCode coincida con la apariencia de su terminal
...
OpenAiCode admite un sistema de temas flexible basado en JSON que permite a los usuarios crear y personalizar temas fácilmente.
