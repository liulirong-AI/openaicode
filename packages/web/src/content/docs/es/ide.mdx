---
title: IDE
description: La extensión OpenAiCode para VS Code, Cursor y otros IDE
---

OpenAiCode se integra con VS Code, Cursor o cualquier IDE que admita un terminal. Simplemente ejecute `opencode` en la terminal para comenzar.

---

## Uso

- **Inicio rápido**: use `Cmd+Esc` (Mac) o `Ctrl+Esc` (Windows/Linux) para abrir OpenAiCode en una vista de terminal dividida, o enfoque una sesión de terminal existente si ya se está ejecutando una.
- **Nueva sesión**: use `Cmd+Shift+Esc` (Mac) o `Ctrl+Shift+Esc` (Windows/Linux) para iniciar una nueva sesión de terminal OpenAiCode, incluso si ya hay una abierta. También puede hacer clic en el botón OpenAiCode en la interfaz de usuario.
- **Conciencia del contexto**: comparte automáticamente tu selección o pestaña actual con OpenAiCode.
...
Para instalar OpenAiCode en VS Code y bifurcaciones populares como Cursor, Windsurf, VSCodium:
...
Busque **OpenAiCode** en Extension Marketplace y haga clic en **Instalar**.
