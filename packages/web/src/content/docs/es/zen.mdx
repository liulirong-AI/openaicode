---
title: Zen
description: Lista seleccionada de modelos proporcionada por OpenAiCode.
---
...
OpenAiCode Zen es una lista de modelos probados y verificados proporcionada por el equipo OpenAiCode.

:::note
OpenAiCode Zen se encuentra actualmente en versión beta.
:::

Zen funciona como cualquier otro proveedor en OpenAiCode. Inicias sesion en OpenAiCode Zen y obtienes
tu API key. Es **completamente opcional** y no necesitas usarlo para usar OpenAiCode.
...
:::tip
Probamos un grupo selecto de modelos y proveedores que funcionan bien con OpenAiCode.
:::
...
OpenAiCode Zen es una puerta de enlace de IA que le brinda acceso a estos modelos.

---

## Cómo funciona

OpenAiCode Zen funciona como cualquier otro proveedor en OpenAiCode.

1. Inicias sesión en **<a href={console}>OpenAiCode Zen</a>**, agregas tu facturación
   detalles y copie su clave API.
2. Ejecuta el comando `/connect` en TUI, selecciona OpenAiCode Zen y pega tu clave API.
...
El [model ID](/docs/config/#models) en tu configuracion de OpenAiCode
...
- MiniMax M2.5 Free está disponible en OpenAiCode por tiempo limitado. El equipo está aprovechando este tiempo para recopilar comentarios y mejorar el modelo.
- Big Pickle es un modelo sigiloso gratuito en OpenAiCode por tiempo limitado. El equipo está aprovechando este tiempo para recopilar comentarios y mejorar el modelo.
...
4. **No tener ningún bloqueo** al permitirle usarlo con cualquier otro agente de codificación. Y siempre le permitirá utilizar cualquier otro proveedor con OpenAiCode también.
