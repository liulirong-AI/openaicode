...
Las habilidades del agente permiten a OpenAiCode descubrir instrucciones reutilizables de su repositorio o directorio de inicio.
...
OpenAiCode busca estas ubicaciones:
...
Para las rutas locales del proyecto, OpenAiCode sube desde su directorio de trabajo actual hasta llegar al árbol de trabajo de git.
...
OpenAiCode enumera las habilidades disponibles en la descripción de la herramienta `skill`.
