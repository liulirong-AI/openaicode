---
title: Compartir
description: Comparte tus conversaciones OpenAiCode.
---

La función para compartir de OpenAiCode te permite crear enlaces públicos a tus conversaciones de OpenAiCode, para que puedas colaborar con compañeros de equipo u obtener ayuda de otros.
...
Cuando compartes una conversación, OpenAiCode:
...
OpenAiCode admite tres modos de compartir que controlan cómo se comparten las conversaciones:

---

### Manual (predeterminado)

De forma predeterminada, OpenAiCode usa el modo de compartir manual. Las sesiones no se comparten automáticamente, pero puedes compartirlas manualmente usando el comando `/share`:
