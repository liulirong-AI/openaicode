---
title: Soporte ACP
description: Utilice OpenAiCode en cualquier editor compatible con ACP.
---

OpenAiCode admite el [Agent Client Protocol](https://agentclientprotocol.com) o (ACP), lo que le permite usarlo directamente en editores e IDE compatibles.
...
Para usar OpenAiCode a través de ACP, configure su editor para ejecutar el comando `opencode acp`.

El comando inicia OpenAiCode como un subproceso compatible con ACP que se comunica con su editor a través de JSON-RPC a través de stdio.
...
Para abrirlo, use el nuevo agente 'OpenAiCode' en el selector de agentes de AI Chat.
...
Para usar OpenAiCode como agente ACP en [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), agregue lo siguiente a su configuración de Neovim:
...
Esta configuración configura CodeCompanion para usar OpenAiCode como agente ACP para el chat.
...
OpenAiCode funciona igual a través de ACP que en la terminal. Todas las funciones son compatibles:
...
- Servidores MCP configurados en su configuración OpenAiCode
