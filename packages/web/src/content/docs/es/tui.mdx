---
title: TUI
description: Usando la interfaz de usuario del terminal OpenAiCode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

OpenAiCode proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar OpenAiCode se inicia TUI para el directorio actual.
...
Cuando utilice OpenAiCode TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a OpenAiCode. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de OpenAiCode. _Alias_: `/quit`, `/q`
