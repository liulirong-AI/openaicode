...
Puede agregar comandos personalizados a través de la configuración OpenAiCode o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su OpenAiCode [config](/docs/config):
