---
title: Web
description: Usando OpenAiCode en su navegador.
---

OpenAiCode puede ejecutarse como una aplicación web en su navegador, brindando la misma poderosa experiencia de codificación de IA sin necesidad de una terminal.

![OpenAiCode Web - Nueva sesión](../../../assets/web/web-homepage-new-session.png)
...
Esto inicia un servidor local en `127.0.0.1` con un puerto disponible aleatorio y abre automáticamente OpenAiCode en su navegador predeterminado.
...
De forma predeterminada, OpenAiCode elige un puerto disponible. Puede especificar un puerto:
...
De forma predeterminada, el servidor se vincula a `127.0.0.1` (solo localhost). Para hacer que OpenAiCode sea accesible en su red:

```bash
opencode web --hostname 0.0.0.0
```

Al usar `0.0.0.0`, OpenAiCode mostrará direcciones locales y de red:
...
Una vez iniciada, la interfaz web proporciona acceso a sus sesiones OpenAiCode.

### Sesiones

Vea y administre sus sesiones desde la página de inicio. Puedes ver sesiones activas e iniciar otras nuevas.

![OpenAiCode Web - Sesión activa](../../../assets/web/web-homepage-active-session.png)

### Estado del servidor

Haga clic en "Ver servidores" para ver los servidores conectados y su estado.

![OpenAiCode Web - Ver Servidores](../../../assets/web/web-homepage-see-servers.png)
