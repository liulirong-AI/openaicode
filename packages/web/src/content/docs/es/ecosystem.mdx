---
title: Ecosistema
description: Proyectos e integraciones construidas con OpenAiCode.
---

Una colección de proyectos comunitarios construidos en OpenAiCode.

:::note
¿Quieres agregar tu proyecto relacionado con OpenAiCode a esta lista? Envíe un PR.
:::
...
| Nombre                                                                                             | Descripción                                                                                                                 |
| -------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Ejecute automáticamente sesiones OpenAiCode en entornos sandbox aislados de Daytona con git sync y vistas previas en vivo     |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Seguimiento del uso de OpenAiCode con Wakatime                                                                                |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Notificaciones de escritorio y alertas sonoras para sesiones OpenAiCode                                                       |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | Nomenclatura automática de sesiones Zellij impulsada por IA basada en el contexto OpenAiCode                                  |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Permitir que los agentes OpenAiCode carguen mensajes de forma diferida a pedido con descubrimiento e inyección de habilidades |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Notificaciones nativas del sistema operativo para OpenAiCode: sepa cuándo se completan las tareas                             |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Árboles de trabajo de Git de fricción cero para OpenAiCode                                                                    |
...
| Nombre                                                                                     | Descripción                                                                          |
| ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------ |
| [kimaki](https://github.com/remorses/kimaki)                                               | Bot de Discord para controlar sesiones OpenAiCode, basado en el SDK                    |
...
| [portal](https://github.com/hosenur/portal)                                                | Interfaz de usuario web móvil para OpenAiCode a través de Tailscale/VPN                |
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Plantilla para crear complementos OpenAiCode                                           |
...
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Proveedor Vercel AI SDK para usar OpenAiCode a través de @opencode-ai/sdk              |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Aplicación web/de escritorio y extensión VS Code para OpenAiCode                       |
| [OpenAiCode-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Complemento de Obsidian que incorpora OpenAiCode en la interfaz de usuario de Obsidian |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Una alternativa de código abierto a Claude Cowork, impulsada por OpenAiCode            |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Administrador de extensiones OpenAiCode con perfiles portátiles y aislados.            |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Aplicación de escritorio, web, móvil y de cliente remoto para OpenAiCode               |
