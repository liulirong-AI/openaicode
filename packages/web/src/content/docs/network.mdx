...
OpenAiCode supports standard proxy environment variables and custom certificates for enterprise network environments.

---

## Proxy

OpenAiCode respects standard proxy environment variables.
...
If your enterprise uses custom CAs for HTTPS connections, configure OpenAiCode to trust them.
