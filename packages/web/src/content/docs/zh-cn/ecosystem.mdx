---
title: 生态系统
description: 基于 OpenAiCode 构建的项目与集成。
---

基于 OpenAiCode 构建的社区项目合集。

:::note
想将您的 OpenAiCode 相关项目添加到此列表中？欢迎提交 PR。
:::
...
| 名称                                                                                               | 描述                                                                   |
| -------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | 在隔离的 Daytona 沙箱中自动运行 OpenAiCode 会话，支持 git 同步和实时预览 |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | 使用 Wakatime 追踪 OpenAiCode 的使用情况                                 |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | OpenAiCode 会话的桌面通知和声音提醒                                      |
| [opencode-notifier](https://github.com/mohak34/opencode-notifier)                                  | 针对权限请求、任务完成和错误事件的桌面通知与声音提醒                   |
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | 基于 OpenAiCode 上下文的 AI 驱动自动 Zellij 会话命名                     |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | 允许 OpenAiCode 代理通过技能发现和注入按需延迟加载提示词                 |
...
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | 将 OpenAiCode /commands 扩展为具有精细流程控制的强大编排系统             |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | OpenAiCode 的原生操作系统通知——随时了解任务完成情况                      |
...
| 名称                                                                                       | 描述                                                          |
| ------------------------------------------------------------------------------------------ | ------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | 用于控制 OpenAiCode 会话的 Discord 机器人，基于 SDK 构建        |
| [opencode.nvim](https://github.com/NickvanDyke/opencode.nvim)                              | Neovim 插件，提供编辑器感知的提示词，基于 API 构建            |
| [portal](https://github.com/hosenur/portal)                                                | 通过 Tailscale/VPN 使用的移动优先 OpenAiCode Web UI             |
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | 用于构建 OpenAiCode 插件的模板                                  |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | OpenAiCode 的 Neovim 前端——基于终端的 AI 编码代理               |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Vercel AI SDK 提供商，用于通过 @opencode-ai/sdk 使用 OpenAiCode |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | OpenAiCode 的 Web / 桌面应用和 VS Code 扩展                     |
| [OpenAiCode-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | 将 OpenAiCode 嵌入 Obsidian UI 的 Obsidian 插件                 |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Claude Cowork 的开源替代方案，由 OpenAiCode 驱动                |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | OpenAiCode 扩展管理器，支持可移植的隔离配置                     |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | OpenAiCode 的桌面、Web、移动和远程客户端应用                    |
