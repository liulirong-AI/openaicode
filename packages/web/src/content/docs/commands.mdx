...
You can add custom commands through the OpenAiCode config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your OpenAiCode [config](/docs/config):
