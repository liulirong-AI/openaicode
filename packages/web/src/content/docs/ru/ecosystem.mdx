---
title: Экосистема
description: Проекты и интеграции, созданные с помощью OpenAiCode.
---

Коллекция проектов сообщества, построенных на OpenAiCode.

:::note
Хотите добавить свой проект, связанный с OpenAiCode, в этот список? Разместите PR.
:::
...
| Имя                                                                                                | Описание                                                                                                                                         |
| -------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Автоматически запускайте сеансы OpenAiCode в изолированных песочницах Daytona с синхронизацией git и предварительным просмотром в реальном времени |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Отслеживайте использование OpenAiCode с помощью Wakatime                                                                                           |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Уведомления на рабочем столе и звуковые оповещения для сеансов OpenAiCode                                                                          |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | Автоматическое именование сеансов Zellij на основе искусственного интеллекта на основе контекста OpenAiCode                                        |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Разрешить агентам OpenAiCode отложенную загрузку подсказок по требованию с обнаружением и внедрением навыков                                       |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Встроенные уведомления ОС для OpenAiCode – узнайте, когда задачи завершены                                                                         |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Рабочие деревья git с нулевым трением для OpenAiCode                                                                                               |
...
| Имя                                                                                        | Описание                                                                                      |
| ------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Discord-бот для управления сеансами OpenAiCode, созданный на базе SDK                           |
...
| [portal](https://github.com/hosenur/portal)                                                | Мобильный веб-интерфейс для OpenAiCode через Tailscale/VPN                                      |
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Шаблон для создания плагинов OpenAiCode                                                         |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Интерфейс Neovim для OpenAiCode - агент кодирования искусственного интеллекта на базе терминала |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Поставщик Vercel AI SDK для использования OpenAiCode через @opencode-ai/sdk                     |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Веб-приложение или настольное приложение и расширение VS Code для OpenAiCode                    |
| [OpenAiCode-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Плагин Obsidian, встраивающий OpenAiCode в пользовательский интерфейс Obsidian                  |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Альтернатива Claude Cowork с открытым исходным кодом на базе OpenAiCode                         |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Менеджер расширений OpenAiCode с переносимыми изолированными профилями                          |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Настольное, веб-, мобильное и удаленное клиентское приложение для OpenAiCode                    |
