...
OpenAiCode gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre OpenAiCode starter TUI for gjeldende katalog.
...
Når du bruker OpenAiCode TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til OpenAiCode. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt OpenAiCode. _Aliaser_: `/quit`, `/q`
