---
title: SDK
description: Typesikker JS-klient for OpenAiCode-server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

OpenAiCode JS/TS SDK gir en typesikker klient for samhandling med serveren.
Bruk den til å bygge integrasjoner og kontrollere OpenAiCode programmatisk.
...
Opprett en forekomst av OpenAiCode:
...
Hvis du allerede har en kjørende forekomst av OpenAiCode, kan du opprette en klientforekomst for å koble til den:
