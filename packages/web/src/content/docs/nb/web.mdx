---
title: Web
description: Bruke OpenAiCode i nettleseren din.
---

OpenAiCode kan kjøres som en nettapplikasjon i nettleseren din, og gir den samme kraftige AI-kodingsopplevelsen uten at du trenger en terminal.

![OpenAiCode Web - Ny økt](../../../assets/web/web-homepage-new-session.png)
...
Dette starter en lokal server på `127.0.0.1` med en tilfeldig tilgjengelig port og åpner automatisk OpenAiCode i standard nettleser.
...
Som standard velger OpenAiCode en tilgjengelig port. Du kan spesifisere en port:
...
Som standard binder serveren seg til `127.0.0.1` (kun localhost). Slik gjør du OpenAiCode tilgjengelig på nettverket ditt:
...
Når den er startet, gir nettgrensesnittet tilgang til dine OpenAiCode-økter.
