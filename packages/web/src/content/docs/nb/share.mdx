...
Delingsfunksjonen i OpenAiCode lar deg lage offentlige lenker til dine OpenAiCode-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Som standard bruker OpenAiCode manuell delingsmodus. Økter deles ikke automatisk, men du kan dele dem manuelt ved å bruke kommandoen `/share`:
