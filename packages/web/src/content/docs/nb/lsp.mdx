...
OpenAiCode integreres med din Language Server Protocol (LSP) for å hjelpe LLM med å samhandle med kodebasen din. Den bruker diagnostikk for å gi tilbakemelding til LLM.

---

## Innebygde servere

OpenAiCode kommer med flere innebygde LSP-servere for populære språk:
...
Du kan tilpasse LSP-servere gjennom `lsp`-delen i OpenAiCode-konfigurasjonen.
