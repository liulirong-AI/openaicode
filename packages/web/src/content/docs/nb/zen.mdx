---
title: Zen
description: Utvalgt liste over modeller levert av OpenAiCode.
---
...
OpenAiCode Zen er en liste over testede og verifiserte modeller levert av OpenAiCode-teamet.

:::note
OpenAiCode Zen er for øyeblikket i beta.
:::

Zen fungerer som alle andre leverandører i OpenAiCode. Du logger på OpenAiCode Zen og får
...
:::tip
Vi testet en utvalgt gruppe modeller og leverandører som fungerer godt med OpenAiCode.
:::
...
OpenAiCode Zen er en AI gateway som gir deg tilgang til disse modellene.

---

## Slik fungerer det

OpenAiCode Zen fungerer som alle andre leverandører i OpenAiCode.

1. Du logger på **<a href={console}>OpenAiCode Zen</a>**, legg til fakturering
   detaljer, og kopier API-nøkkelen.
2. Du kjører kommandoen `/connect` i TUI, velger OpenAiCode Zen og limer inn API-nøkkelen.
...
[modell-id](/docs/config/#models) i OpenAiCode-konfigurasjonen
...
- MiniMax M2.5 Free er tilgjengelig på OpenAiCode i en begrenset periode. Teamet bruker denne tiden til å samle tilbakemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på OpenAiCode i en begrenset periode. Teamet bruker denne tiden til å samle tilbakemeldinger og forbedre modellen.
...
Vi opprettet OpenAiCode Zen for å:
...
4. Ha **ingen låsing** ved å la deg bruke den med en hvilken som helst annen kodeagent. Og la deg alltid bruke en hvilken som helst annen leverandør med OpenAiCode også.
