---
title: Ecossistema
description: Projetos e integrações construídos com o OpenAiCode.
---

Uma coleção de projetos da comunidade construídos sobre o OpenAiCode.

:::note
Quer adicionar seu projeto relacionado ao OpenAiCode a esta lista? Envie um PR.
:::
...
| Nome                                                                                               | Descrição                                                                                                                      |
| -------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------ |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Execute automaticamente sessões do OpenAiCode em sandboxes isoladas do Daytona com sincronização git e pré-visualizações ao vivo |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Acompanhe o uso do OpenAiCode com Wakatime                                                                                       |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Notificações de desktop e alertas sonoros para sessões do OpenAiCode                                                             |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | Nomeação automática de sessões Zellij com suporte de IA com base no contexto do OpenAiCode                                       |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Permite que agentes do OpenAiCode carreguem prompts sob demanda com descoberta e injeção de habilidades                          |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Notificações nativas do OS para OpenAiCode – saiba quando as tarefas são concluídas                                              |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Worktrees git sem atrito para OpenAiCode                                                                                         |
...
| Nome                                                                                       | Descrição                                                                       |
| ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Bot do Discord para controlar sessões do OpenAiCode, construído sobre o SDK       |
...
| [portal](https://github.com/hosenur/portal)                                                | UI web mobile-first para OpenAiCode sobre Tailscale/VPN                           |
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Template para construir plugins do OpenAiCode                                     |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Frontend Neovim para OpenAiCode - um agente de codificação IA baseado em terminal |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Provedor Vercel AI SDK para usar OpenAiCode via @opencode-ai/sdk                  |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Aplicativo Web / Desktop e Extensão do VS Code para OpenAiCode                    |
| [OpenAiCode-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Plugin Obsidian que incorpora OpenAiCode na UI do Obsidian                        |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Uma alternativa de código aberto ao Claude Cowork, alimentada pelo OpenAiCode     |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Gerenciador de extensões OpenAiCode com perfis portáteis e isolados.              |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Aplicativo Desktop, Web, Mobile e Cliente Remoto para OpenAiCode                  |
