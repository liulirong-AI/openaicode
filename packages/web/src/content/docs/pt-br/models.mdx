...
Aqui, o ID completo é `provider_id/model_id`. Por exemplo, se você estiver usando [OpenAiCode Zen](/docs/zen), você usaria `opencode/gpt-5.1-codex` para GPT 5.1 Codex.
