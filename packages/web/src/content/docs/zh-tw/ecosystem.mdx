---
title: 生態系統
description: 基於 OpenAiCode 建置的專案與整合。
---

基於 OpenAiCode 建置的社群專案合集。

:::note
想將您的 OpenAiCode 相關專案新增到此列表中？歡迎提交 PR。
:::
...
| 名稱                                                                                               | 說明                                                                       |
| -------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | 在隔離的 Daytona 沙箱中自動執行 OpenAiCode 工作階段，支援 git 同步和即時預覽 |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | 使用 Wakatime 追蹤 OpenAiCode 的使用情況                                     |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | OpenAiCode 工作階段的桌面通知和聲音提醒                                      |
| [opencode-notifier](https://github.com/mohak34/opencode-notifier)                                  | 針對權限請求、任務完成和錯誤事件的桌面通知與聲音提醒                       |
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | 基於 OpenAiCode 上下文的 AI 驅動自動 Zellij 工作階段命名                     |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | 允許 OpenAiCode 代理透過技能發現和注入按需延遲載入提示詞                     |
...
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | 將 OpenAiCode /commands 擴展為具有精細流程控制的強大編排系統                 |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | OpenAiCode 的原生作業系統通知——隨時了解任務完成情況                          |
| [opencode-workspace](https://github.com/kdcokenny/opencode-workspace)                              | 捆綁式多代理編排套件——16 個元件，一次安裝                                  |
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | OpenAiCode 的零摩擦 git worktree 管理                                        |
...
| 名稱                                                                                       | 說明                                                          |
| ------------------------------------------------------------------------------------------ | ------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | 用於控制 OpenAiCode 工作階段的 Discord 機器人，基於 SDK 建置    |
| [opencode.nvim](https://github.com/NickvanDyke/opencode.nvim)                              | Neovim 外掛程式，提供編輯器感知的提示詞，基於 API 建置        |
| [portal](https://github.com/hosenur/portal)                                                | 透過 Tailscale/VPN 使用的行動優先 OpenAiCode Web UI             |
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | 用於建置 OpenAiCode 外掛程式的範本                              |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | OpenAiCode 的 Neovim 前端——基於終端機的 AI 編碼代理             |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Vercel AI SDK 供應商，用於透過 @opencode-ai/sdk 使用 OpenAiCode |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | OpenAiCode 的 Web / 桌面應用程式和 VS Code 擴充功能             |
| [OpenAiCode-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | 將 OpenAiCode 嵌入 Obsidian UI 的 Obsidian 外掛程式             |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Claude Cowork 的開源替代方案，由 OpenAiCode 驅動                |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | OpenAiCode 擴充功能管理器，支援可攜式的隔離設定                 |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | OpenAiCode 的桌面、Web、行動和遠端用戶端應用程式                |
