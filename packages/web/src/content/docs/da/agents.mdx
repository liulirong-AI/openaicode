...
Der er to typer agenter i OpenAiCode; primære agenter og subagenter.
...
OpenAiCode leveres med indbyggede primære agenter, **Build** og **Plan**. Vi vil
...
OpenAiCode leveres med to indbyggede underagenter, **Generelt** og **Udforsk**. Vi vil se på dette nedenfor.

---

## Indbyggede

OpenAiCode leveres med to indbyggede primære agenter og to indbyggede subagenter.
...
Hvis ingen temperatur er angivet, bruger OpenAiCode modelspecifikke standardindstillinger; typisk 0 for de fleste modeller, 0,55 for Qwen-modeller.
...
Denne sti er i forhold til, hvor konfigurationsfilen er placeret. Så dette virker både for den globale OpenAiCode-konfiguration og den projektspecifikke konfiguration.
...
Model-id'et i din OpenAiCode-konfiguration brugerformatet `provider/model-id`. For eksempel, hvis du bruger [OpenAiCode Zen](/docs/zen), vil du bruge `opencode/gpt-5.1-codex` til GPT 5.1 Codex.
