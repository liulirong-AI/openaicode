...
Du kan tilføje brugerdefinerede kommandoer gennem OpenAiCode-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din OpenAiCode [config](/docs/config):
