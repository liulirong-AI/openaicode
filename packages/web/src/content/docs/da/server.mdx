...
[`/tui`](#tui) endpointet kan bruges til at køre TUI gennem serveren. Du kan for eksempel forududfylde eller køre en forespørgsel. Denne opsætning bruges af OpenAiCode [IDE](/docs/ide) plugins.
...
OpenAiCode-serveren viser følgende API'er.
