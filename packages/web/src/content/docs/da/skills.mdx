...
Agentferdigheter lar OpenAiCode oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
OpenAiCode søker etter disse stedene:
...
For prosjektlokale stier går OpenAiCode opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
...
OpenAiCode viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
