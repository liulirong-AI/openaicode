---
title: LSP-servere
description: OpenAiCode integreres med dine LSP-servere.
---

OpenAiCode integreres med Language Server Protocol (LSP) for at hjælpe LLM med at interagere med din kodebase. Den bruger diagnostik til at give feedback til LLM.

---

## Indbyggede

OpenAiCode leveres med flere indbyggede LSP-servere til populære sprog:
