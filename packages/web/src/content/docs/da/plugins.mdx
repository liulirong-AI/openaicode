---
title: Plugins
description: Skriv dine egne plugins for at udvide OpenAiCode.
---

Plugins giver dig mulighed for at udvide OpenAiCode ved at tilslutte sig forskellige begivenheder og tilpasse adfærd. Du kan oprette plugins for at tilføje nye funktioner, integrere med eksterne tjenester eller ændre OpenAiCodes standardadfærd.
...
OpenAiCode kører `bun install` ved opstart for at installere disse. Dine plugins og værktøjer kan derefter importere dem.
...
:::note
Hvis du bruger OpenAiCode desktop-appen, kan den sende systemmeddelelser automatisk, når et svar er klar, eller når en session fejler.
:::
