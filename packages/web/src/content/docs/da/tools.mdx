...
Her er alle de innebygde verktøyene som er tilgængelige i OpenAiCode.
...
:::note
Dette verktøyet er bare tilgængelig når du bruger OpenAiCode-leverandøren eller når miljøvariabelen `OPENCODE_ENABLE_EXA` er satt til en sannverdi (f.eks. `true` eller `1`).
