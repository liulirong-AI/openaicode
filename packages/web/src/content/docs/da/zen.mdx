---
title: Zen
description: Udvalgt liste over modeller leveret af OpenAiCode.
---
...
OpenAiCode Zen er en liste over testede og verificerede modeller leveret af OpenAiCode-teamet.

:::note
OpenAiCode Zen er i øjeblikket i beta.
:::

Zen fungerer som alle andre udbydere i OpenAiCode. Du logger på OpenAiCode Zen og får
...
:::tip
Vi testede en udvalgt gruppe modeller og udbydere, der fungerer godt med OpenAiCode.
:::
...
OpenAiCode Zen er en AI gateway, der giver dig adgang til disse modeller.

---

## Sådan fungerer det

OpenAiCode Zen fungerer som alle andre udbydere i OpenAiCode.

1. Du logger på **<a href={console}>OpenAiCode Zen</a>**, tilføjer faktureringsoplysninger
   og kopierer API-nøglen.
2. Du kører kommandoen `/connect` i TUI, vælger OpenAiCode Zen og indsætter API-nøglen.
...
[model-id](/docs/config/#models) i OpenAiCode-konfigurationen
...
- MiniMax M2.5 Gratis er tilgængelig på OpenAiCode i en begrænset periode. Teamet bruger denne tid til at samle feedback og forbedre modellen.
- Stor sylteagurk er en stealth-model som er gratis på OpenAiCode i en begrænset periode. Teamet bruger denne tid til at samle feedback og forbedre modellen.
...
Vi oprettede OpenAiCode Zen for at:
...
4. Have **ingen fastlåsning** ved at lade dig bruge den med en hvilken som helst anden kodeagent. Og lade dig altid bruge en hvilken som helst anden udbyder med OpenAiCode også.
