---
title: Deling
description: Del dine OpenAiCode-samtaler.
---

OpenAiCodes delingsfunksjon lar deg lage offentlige lenker til dine OpenAiCode-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Når du deler en samtale, OpenAiCode:
...
OpenAiCode støtter tre delingsmoduser som kontrollerer hvordan samtaler deles:

---

### Manuel (standard)

Som standard bruger OpenAiCode manuell delingsmodus. Sessioner deles ikke automatisk, men du kan dele dem manuelt ved at bruge kommandoen `/share`:
