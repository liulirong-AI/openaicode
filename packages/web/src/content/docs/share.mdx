---
title: Share
description: Share your OpenAiCode conversations.
---

OpenAiCode's share feature allows you to create public links to your OpenAiCode conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, OpenAiCode:
...
OpenAiCode supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, OpenAiCode uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
