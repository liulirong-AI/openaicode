---
title: エコシステム
description: OpenAiCode で構築されたプロジェクトと統合。
---

OpenAiCode に基づいて構築されたコミュニティプロジェクトのコレクション。

:::note
OpenAiCode 関連プロジェクトをこのリストに追加したいですか? PR を送信してください。
:::
...
| 名前                                                                                               | 説明                                                                                                                 |
| -------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | git sync とライブプレビューを使用して、隔離された Daytona サンドボックスで OpenAiCode セッションを自動的に実行します。 |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | wakatime で OpenAiCode の使用状況を追跡する                                                                            |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | OpenAiCode セッションのデスクトップ通知とサウンドアラート                                                              |
| [opencode-notifier](https://github.com/mohak34/opencode-notifier)                                  | 許可、完了、エラーイベントのデスクトップ通知とサウンドアラート                                                       |
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | OpenAiCode コンテキストに基づいた AI による自動 Zellij セッション命名                                                  |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | OpenAiCode エージェントがスキルの検出と挿入を使用してオンデマンドでプロンプトを遅延ロードできるようにする              |
...
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | OpenAiCode/コマンドをきめ細かいフロー制御を備えた強力なオーケストレーションシステムに拡張                              |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | OpenAiCode のネイティブ OS 通知 – タスクがいつ完了したかを知る                                                         |
| [opencode-workspace](https://github.com/kdcokenny/opencode-workspace)                              | バンドルされたマルチエージェントオーケストレーションハーネス – 16 コンポーネント、1 回のインストール                 |
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | OpenAiCode 用のゼロフリクション Git ワークツリー                                                                       |
...
| 名前                                                                                       | 説明                                                                             |
| ------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | SDK 上に構築された OpenAiCode セッションを制御する Discord ボット                  |
| [opencode.nvim](https://github.com/NickvanDyke/opencode.nvim)                              | API に基づいて構築された、エディター対応プロンプト用の Neovim プラグイン         |
| [portal](https://github.com/hosenur/portal)                                                | Tailscale/VPN 上の OpenAiCode 向けモバイルファースト Web UI                        |
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | OpenAiCode プラグインを構築するためのテンプレート                                  |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Neovim OpenAiCode用フロントエンド - ターミナルベースの AI コーディングエージェント |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | @opencode-ai/sdk 経由で OpenAiCode を使用するための Vercel AI SDK プロバイダー     |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | OpenAiCode 用の Web/デスクトップアプリと VS Code 拡張機能                          |
| [OpenAiCode-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Obsidian の UI に OpenAiCode を埋め込む Obsidian プラグイン                        |
| [OpenWork](https://github.com/different-ai/openwork)                                       | OpenAiCode を利用した、Claude Cowork に代わるオープンソース                        |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | 移植可能な独立したプロファイルを備えた OpenAiCode 拡張機能マネージャー。           |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | OpenAiCode 用のデスクトップ、Web、モバイル、およびリモートクライアントアプリ       |
