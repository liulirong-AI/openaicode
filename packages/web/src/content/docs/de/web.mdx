---
title: Web
description: Verwenden Sie OpenAiCode in Ihrem Browser.
---

OpenAiCode kann als Webanwendung in Ihrem Browser ausgeführt werden und bietet das gleiche leistungsstarke KI-Codierungserlebnis, ohne dass ein Terminal erforderlich ist.

![OpenAiCode Web – Neue Sitzung](../../../assets/web/web-homepage-new-session.png)
...
Dadurch wird ein lokaler Server auf `127.0.0.1` mit einem zufällig verfügbaren Port gestartet und OpenAiCode automatisch in Ihrem Standardbrowser geöffnet.
...
Standardmäßig wählt OpenAiCode einen verfügbaren Port aus. Sie können einen Port angeben:
...
Standardmäßig bindet der Server an `127.0.0.1` (nur localhost). So machen Sie OpenAiCode in Ihrem Netzwerk zugänglich:

```bash
opencode web --hostname 0.0.0.0
```

Bei Verwendung von `0.0.0.0` zeigt OpenAiCode sowohl lokale als auch Netzwerkadressen an:
...
Nach dem Start bietet die Weboberfläche Zugriff auf Ihre OpenAiCode-Sitzungen.

### Sitzungen

Zeigen Sie Ihre Sitzungen auf der Startseite an und verwalten Sie sie. Sie können aktive Sitzungen sehen und neue starten.

![OpenAiCode Web – Aktive Sitzung](../../../assets/web/web-homepage-active-session.png)

### Serverstatus

Klicken Sie auf „Server anzeigen“, um verbundene Server und deren Status anzuzeigen.

![OpenAiCode Web – Siehe Server](../../../assets/web/web-homepage-see-servers.png)
