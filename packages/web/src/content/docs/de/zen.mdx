---
title: Zen
description: Kuratierte Modellliste direkt von OpenAiCode.
---
...
OpenAiCode Zen ist eine vom OpenAiCode-Team getestete und verifizierte Modellliste.

:::note
OpenAiCode Zen befindet sich aktuell in der Beta.
:::

Zen funktioniert wie jeder andere Provider in OpenAiCode.
Du meldest dich bei OpenAiCode Zen an, holst dir deinen API-Key und nutzt ihn optional.
...
:::tip
Wir haben eine Auswahl aus Modellen und Providern getestet, die gut mit OpenAiCode funktionieren.
:::
...
OpenAiCode Zen ist ein AI-Gateway, das dir Zugriff auf genau diese Modelle gibt.

---

## Funktionsweise

OpenAiCode Zen funktioniert wie jeder andere Provider in OpenAiCode.

1. Melde dich bei **<a href={console}>OpenAiCode Zen</a>** an, hinterlege Zahlungsdaten und kopiere deinen API-Key.
2. Fuehre in der TUI `/connect` aus, waehle OpenAiCode Zen und fuege den API-Key ein.
...
Die [Model-ID](/docs/config/#models) in deiner OpenAiCode-Konfiguration hat das Format `opencode/<model-id>`.
...
- MiniMax M2.5 Free ist fuer begrenzte Zeit auf OpenAiCode verfuegbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Big Pickle ist ein Stealth-Modell, das fuer begrenzte Zeit kostenlos auf OpenAiCode verfuegbar ist. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
...
Wir haben OpenAiCode Zen entwickelt, um:
...
4. **Kein Lock-in** zu erzwingen, damit du Zen mit anderen Coding-Agents und OpenAiCode weiter mit anderen Providern nutzen kannst
