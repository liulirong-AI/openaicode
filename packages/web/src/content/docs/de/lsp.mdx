---
title: LSP Server
description: OpenAiCode lässt sich in Ihren LSP-Server integrieren.
---

OpenAiCode lässt sich in Ihr Language Server Protocol (LSP) integrieren, um die Interaktion von LLM mit Ihrer Codebasis zu unterstützen. Es verwendet Diagnosefunktionen, um dem LLM Feedback zu geben.

---

## Integriert

OpenAiCode verfügt über mehrere integrierte LSP-Server für gängige Sprachen:
...
Wenn OpenAiCode eine Datei öffnet, geschieht Folgendes:
...
Sie können LSP-Server über den Abschnitt `lsp` in Ihrer OpenAiCode-Konfiguration anpassen.
