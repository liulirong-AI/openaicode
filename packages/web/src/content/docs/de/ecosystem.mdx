---
title: Ökosystem
description: Mit OpenAiCode erstellte Projekte und Integrationen.
---

Eine Sammlung von Community-Projekten, die auf OpenAiCode basieren.

:::note
Möchten Sie Ihr OpenAiCode-bezogenes Projekt zu dieser Liste hinzufügen? Senden Sie einen PR.
:::
...
| Name                                                                                               | Beschreibung                                                                                                                  |
| -------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Führen Sie OpenAiCode-Sitzungen automatisch in isolierten Daytona-Sandboxes mit Git-Synchronisierung und Live-Vorschauen aus    |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Verfolgen Sie die Nutzung von OpenAiCode mit Wakatime                                                                           |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Desktop-Benachrichtigungen und akustische Warnungen für OpenAiCode-Sitzungen                                                    |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | AI-gestützte automatische Benennung von Zellij-Sitzungen basierend auf dem OpenAiCode-Kontext                                   |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Ermöglichen Sie OpenAiCode-Agenten das verzögerte Laden von Eingabeaufforderungen bei Bedarf mit Skill-Erkennung und -Injektion |
...
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Erweitern Sie OpenAiCode /commands zu einem leistungsstarken Orchestrierungssystem mit granularer Flusskontrolle                |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Native OS-Benachrichtigungen für OpenAiCode – wissen, wann Aufgaben erledigt sind                                               |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Reibungslose Git-Arbeitsbäume für OpenAiCode                                                                                    |
...
| Name                                                                                       | Beschreibung                                                                 |
| ------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Discord-Bot zur Steuerung von OpenAiCode-Sitzungen, basierend auf SDK          |
...
| [portal](https://github.com/hosenur/portal)                                                | Mobile-First-Web UI für OpenAiCode über Tailscale/VPN                          |
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Vorlage zum Erstellen von OpenAiCode-Plugins                                   |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Neovim-Frontend für OpenAiCode – ein terminalbasierter AI-Coding-Agent         |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Vercel AI SDK Anbieter für die Verwendung von OpenAiCode über @opencode-ai/sdk |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Web-/Desktop-App und VS Code-Erweiterung für OpenAiCode                        |
| [OpenAiCode-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Obsidian-Plugin, das OpenAiCode in Obsidians UI einbettet                      |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Eine Open-Source-Alternative zu Claude Cowork, unterstützt von OpenAiCode      |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | OpenAiCode Erweiterungsmanager mit portablen, isolierten Profilen.             |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Desktop-, Web-, Mobil- und Remote-Client-App für OpenAiCode                    |
