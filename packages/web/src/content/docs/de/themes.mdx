...
Mit OpenAiCode kannst du ein eingebautes Theme waehlen, ein an dein Terminal angepasstes Theme nutzen oder ein eigenes Theme definieren.

Standardmaessig verwendet OpenAiCode das `opencode`-Theme.
...
OpenAiCode liefert mehrere eingebaute Themes mit.
...
- OpenAiCode optisch ans Terminal anpassen wollen
...
OpenAiCode unterstuetzt ein flexibles JSON-basiertes Theme-System.
