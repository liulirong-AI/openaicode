...
Agent Skills erlauben OpenAiCode, wiederverwendbare Anweisungen aus deinem Repo oder Home-Verzeichnis zu finden.
...
OpenAiCode sucht in folgenden Pfaden:
...
Bei projektlokalen Pfaden laeuft OpenAiCode vom aktuellen Verzeichnis nach oben bis zum Git-Worktree.
...
OpenAiCode listet verfuegbare Skills in der Beschreibung des `skill`-Tools.
