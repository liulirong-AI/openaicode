---
title: SDK
description: Typowany klient JS dla serwera OpenAiCode.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Pakiet SDK JS/TS OpenAiCode zapewnia klienta z bezpiecznym typowaniem (type-safe) do interakcji z serwerem.
Użyj go do budowania integracji i programowej kontroli OpenAiCode.
...
Jeśli masz już działającą instancję OpenAiCode, możesz utworzyć instancję klienta, aby się z nią połączyć:
