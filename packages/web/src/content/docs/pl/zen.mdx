---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez OpenAiCode.
---
...
OpenAiCode Zen to lista przetestowanych i zweryfikowanych modeli udostępniona przez zespół OpenAiCode.

:::note
OpenAiCode Zen jest obecnie w wersji beta.
:::

Zen działa jak każdy inny dostawca w OpenAiCode. Logujesz się do OpenAiCode Zen i otrzymujesz
...
OpenAiCode Zen to brama AI, która zapewnia dostęp do tych modeli.

---

## Jak to działa

OpenAiCode Zen działa jak każdy inny dostawca w OpenAiCode.

1. Logujesz się do **<a href={console}>OpenAiCode Zen</a>**, dodajesz dane rozliczeniowe
   i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz OpenAiCode Zen i wklejasz klucz API.
...
[Identyfikator modelu](/docs/config/#models) w konfiguracji OpenAiCode
...
- MiniMax M2.5 Free jest dostępny w OpenAiCode przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
- Big Pickle to ukryty model, który jest bezpłatny w OpenAiCode przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
...
Stworzyliśmy OpenAiCode Zen, aby:
...
4. Nie **mieć blokady** (no lock-in), umożliwiając używanie go z dowolnym innym agentem kodującym. I zawsze pozwalać na korzystanie z dowolnego innego dostawcy w OpenAiCode.
