---
title: Ekosistem
description: OpenAiCode ile geliştirilen projeler ve entegrasyonlar.
---

OpenAiCode üzerine inşa edilmiş topluluk projeleri koleksiyonu.

:::note
OpenAiCode ile ilgili projenizi bu listeye eklemek ister misiniz? Bir PR gönderin.
:::
...
| İsim                                                                                               | Açıklama                                                                                                                      |
| -------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | OpenAiCode oturumlarını, git senkronizasyonu ve canlı önizlemelerle izole Daytona sanal alanlarında otomatik olarak çalıştırın  |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Wakatime ile OpenAiCode kullanımını takip edin                                                                                  |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | OpenAiCode oturumları için masaüstü bildirimleri ve sesli uyarılar                                                              |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | OpenAiCode bağlamına dayalı yapay zeka destekli otomatik Zellij oturum isimlendirmesi                                           |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | OpenAiCode aracılarının, beceri keşfi ve enjeksiyonu ile istemleri talep üzerine tembel yüklemesine (lazy load) izin verin      |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | OpenAiCode için yerel işletim sistemi bildirimleri – görevlerin ne zaman tamamlandığını bilin                                   |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | OpenAiCode için sıfır sürtünmeli git çalışma ağaçları (worktrees)                                                               |
...
| İsim                                                                                       | Açıklama                                                                        |
| ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | SDK üzerine inşa edilmiş, OpenAiCode oturumlarını kontrol eden Discord botu       |
...
| [portal](https://github.com/hosenur/portal)                                                | Tailscale/VPN üzerinden OpenAiCode için mobil öncelikli web arayüzü               |
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | OpenAiCode eklentileri oluşturmak için şablon                                     |
...
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | @opencode-ai/sdk aracılığıyla OpenAiCode kullanmak için Vercel AI SDK sağlayıcısı |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | OpenAiCode için Web / Masaüstü Uygulaması ve VS Code Uzantısı                     |
| [OpenAiCode-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | OpenAiCode'u Obsidian arayüzüne gömen Obsidian eklentisi                          |
| [OpenWork](https://github.com/different-ai/openwork)                                       | OpenAiCode tarafından desteklenen, Claude Cowork'e açık kaynaklı bir alternatif   |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Taşınabilir, izole profillere sahip OpenAiCode eklenti yöneticisi                 |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | OpenAiCode için Masaüstü, Web, Mobil ve Uzak İstemci Uygulaması                   |
