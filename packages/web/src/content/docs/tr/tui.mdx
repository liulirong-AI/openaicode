---
title: TUI
description: OpenAiCode terminal kullanıcı arayüzünü kullanma.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

OpenAiCode, projelerinizde LLM ile çalışmak için etkileşimli bir terminal arayüzü (TUI) sunar.

OpenAiCode'u çalıştırdığınızda mevcut dizin için TUI başlar.
...
OpenAiCode TUI kullanırken `/` ve ardından komut adını yazarak hızlı eylemler çalıştırabilirsiniz. Örneğin:
...
OpenAiCode'a bir sağlayıcı ekler. Mevcut sağlayıcıları seçip API anahtarları eklemenizi sağlar.
...
OpenAiCode'dan çıkar. _Takma adlar_: `/quit`, `/q`
