---
title: خوادم LSP
description: يتكامل OpenAiCode مع خوادم LSP لديك.
---

يتكامل OpenAiCode مع بروتوكول خادم اللغة (LSP) لمساعدة LLM على التفاعل مع قاعدة الشيفرة لديك. ويستخدم التشخيصات لتزويد LLM بتغذية راجعة.

---

## المدمجة

يأتي OpenAiCode مع عدة خوادم LSP مدمجة للغات الشائعة:
