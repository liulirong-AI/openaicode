...
تتيح مهارات الوكيل لـ OpenAiCode اكتشاف تعليمات قابلة لإعادة الاستخدام من مستودعك أو من دليل المنزل.
...
يبحث OpenAiCode في هذه المواقع:
...
بالنسبة لمسارات المشروع المحلية، يتدرج OpenAiCode صعوداً من دليل العمل الحالي حتى يصل إلى `git worktree`.
...
يعرض OpenAiCode المهارات المتاحة في وصف أداة `skill`.
