...
مع OpenAiCode يمكنك الاختيار من بين عدة سمات مدمجة، أو استخدام سمة تتكيّف مع سمة terminal لديك، أو تعريف سمة مخصصة خاصة بك.

افتراضيًا، يستخدم OpenAiCode سمتنا `opencode`.
...
يأتي OpenAiCode مع عدة سمات مدمجة.
...
- يريدون أن يطابق OpenAiCode مظهر terminal لديهم
...
يدعم OpenAiCode نظام سمات مرنًا قائمًا على JSON يتيح للمستخدمين إنشاء السمات وتخصيصها بسهولة.
