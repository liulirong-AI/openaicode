...
يوجد نوعان من الوكلاء في OpenAiCode: وكلاء أساسيون ووكلاء فرعيون.
...
يأتي OpenAiCode مع وكيلين أساسيين مدمجين: **Build** و **Plan**. سنلقي نظرة عليهما أدناه.
...
يأتي OpenAiCode مع وكيلين فرعيين مدمجين: **General** و **Explore**. سنلقي نظرة على ذلك أدناه.

---

## المدمجة

يأتي OpenAiCode مع وكيلين أساسيين مدمجين ووكيلين فرعيين مدمجين.
...
إذا لم يتم تحديد temperature، يستخدم OpenAiCode القيم الافتراضية الخاصة بالنموذج؛ عادة 0 لمعظم النماذج و 0.55 لنماذج Qwen.
...
هذا المسار نسبي لمكان وجود ملف الإعدادات. لذلك يعمل هذا لكل من إعدادات OpenAiCode العامة وإعدادات المشروع.
...
يستخدم معرّف النموذج في إعدادات OpenAiCode الصيغة `provider/model-id`. على سبيل المثال، إذا كنت تستخدم [OpenAiCode Zen](/docs/zen)، فستستخدم `opencode/gpt-5.1-codex` لـ GPT 5.1 Codex.
