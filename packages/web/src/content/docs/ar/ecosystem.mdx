---
title: النظام البيئي
description: مشاريع وتكاملات مبنية باستخدام OpenAiCode.
---

مجموعة من مشاريع المجتمع المبنية على OpenAiCode.

:::note
هل تريد إضافة مشروعك المتعلق بـ OpenAiCode إلى هذه القائمة؟ أرسل طلب سحب (PR).
:::
...
| الاسم                                                                                              | الوصف                                                                                                          |
| -------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | تشغيل جلسات OpenAiCode تلقائيًا في صناديق حماية Daytona معزولة مع مزامنة git ومعاينات حية                        |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | تتبع استخدام OpenAiCode باستخدام Wakatime                                                                        |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | إشعارات سطح المكتب وتنبيهات صوتية لجلسات OpenAiCode                                                              |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | تسمية جلسات Zellij تلقائيًا بدعم الذكاء الاصطناعي بناءً على سياق OpenAiCode                                      |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | السماح لوكلاء OpenAiCode بتحميل المطالبات (prompts) بشكل كسول عند الطلب مع اكتشاف المهارات وحقنها                |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | إشعارات نظام التشغيل الأصلية لـ OpenAiCode – اعرف متى تكتمل المهام                                               |
| [opencode-workspace](https://github.com/kdcokenny/opencode-workspace)                              | حزمة تنسيق متعددة الوكلاء – 16 مكونًا، تثبيت واحد                                                              |
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | أشجار عمل git (worktrees) خالية من الاحتكاك لـ OpenAiCode                                                        |
...
| الاسم                                                                                      | الوصف                                                                     |
| ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | بوت Discord للتحكم في جلسات OpenAiCode، مبني على SDK                        |
| [opencode.nvim](https://github.com/NickvanDyke/opencode.nvim)                              | إضافة Neovim للمطالبات المدركة للمحرر، مبنية على API                      |
| [portal](https://github.com/hosenur/portal)                                                | واجهة ويب مخصصة للجوال لـ OpenAiCode عبر Tailscale/VPN                      |
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | قالب لبناء إضافات OpenAiCode                                                |
...
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | موفر Vercel AI SDK لاستخدام OpenAiCode عبر @opencode-ai/sdk                 |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | تطبيق ويب / سطح مكتب وامتداد VS Code لـ OpenAiCode                          |
| [OpenAiCode-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | إضافة Obsidian تدمج OpenAiCode في واجهة مستخدم Obsidian                     |
| [OpenWork](https://github.com/different-ai/openwork)                                       | بديل مفتوح المصدر لـ Claude Cowork، مدعوم بواسطة OpenAiCode                 |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | مدير امتدادات OpenAiCode مع ملفات تعريف محمولة ومعزولة.                     |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | تطبيق عميل لسطح المكتب والويب والجوال وعن بعد لـ OpenAiCode                 |
