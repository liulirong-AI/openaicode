---
title: TUI
description: استخدام واجهة المستخدم TUI في OpenAiCode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر OpenAiCode واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل OpenAiCode إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة OpenAiCode في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى OpenAiCode. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من OpenAiCode. _الأسماء المستعارة_: `/quit`, `/q`
...
يمكنك تخصيص سلوك واجهة TUI عبر ملف إعدادات OpenAiCode.
