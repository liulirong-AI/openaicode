...
يمكنك إضافة أوامر مخصصة عبر إعدادات OpenAiCode أو بإنشاء ملفات Markdown داخل الدليل `commands/`.

---

### JSON

استخدم خيار `command` في [config](/docs/config) الخاص بـ OpenAiCode:
