---
title: Zen
description: قائمة منتقاة من النماذج يوفّرها OpenAiCode.
---
...
OpenAiCode Zen هي قائمة بالنماذج التي اختبرها فريق OpenAiCode وتحقّق منها.

:::note
OpenAiCode Zen متاح حاليا بنسخة تجريبية.
:::

يعمل Zen مثل أي مزوّد آخر في OpenAiCode. تسجّل الدخول إلى OpenAiCode Zen وتحصل على
مفتاح API. استخدامه **اختياري بالكامل** ولا تحتاج إليه لاستخدام OpenAiCode.
...
:::tip
اختبرنا مجموعة منتقاة من النماذج والمزوّدين الذين يعملون جيدا مع OpenAiCode.
:::
...
OpenAiCode Zen هو بوابة للذكاء الاصطناعي تتيح لك الوصول إلى هذه النماذج.

---

## كيف يعمل

يعمل OpenAiCode Zen مثل أي مزوّد آخر في OpenAiCode.

1. تسجّل الدخول إلى **<a href={console}>OpenAiCode Zen</a>**، وتضيف تفاصيل الفوترة، ثم تنسخ مفتاح API.
2. تشغّل الأمر `/connect` في واجهة TUI، وتختار OpenAiCode Zen، ثم تلصق مفتاح API.
...
يستخدم [معرّف النموذج](/docs/config/#models) في إعدادات OpenAiCode الصيغة `opencode/<model-id>`.
...
- MiniMax M2.5 Free متاح على OpenAiCode لفترة محدودة. يستخدم الفريق هذه الفترة لجمع الملاحظات وتحسين النموذج.
- Big Pickle نموذج خفي ومتاح مجانا على OpenAiCode لفترة محدودة. يستخدم الفريق هذه الفترة لجمع الملاحظات وتحسين النموذج.
...
4. عدم فرض **أي ارتباط حصري (lock-in)** عبر تمكينك من استخدامه مع أي عامل برمجة آخر، مع إتاحة استخدام أي مزوّد آخر مع OpenAiCode أيضا.
