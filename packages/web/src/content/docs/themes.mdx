...
With OpenAiCode you can select from one of several built-in themes, use a theme that adapts to your terminal theme, or define your own custom theme.

By default, OpenAiCode uses our own `opencode` theme.
...
OpenAiCode comes with several built-in themes.
...
- Want OpenAiCode to match their terminal's appearance
...
OpenAiCode supports a flexible JSON-based theme system that allows users to create and customize themes easily.
