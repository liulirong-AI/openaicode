---
title: Zen
description: Curated list of models provided by OpenAiCode.
---
...
OpenAiCode Zen is a list of tested and verified models provided by the OpenAiCode team.

:::note
OpenAiCode Zen is currently in beta.
:::

Zen works like any other provider in OpenAiCode. You login to OpenAiCode Zen and get
...
:::tip
We tested a select group of models and providers that work well with OpenAiCode.
:::
...
OpenAiCode Zen is an AI gateway that gives you access to these models.

---

## How it works

OpenAiCode Zen works like any other provider in OpenAiCode.

1. You sign in to **<a href={console}>OpenAiCode Zen</a>**, add your billing
   details, and copy your API key.
2. You run the `/connect` command in the TUI, select OpenAiCode Zen, and paste your API key.
...
The [model id](/docs/config/#models) in your OpenAiCode config
...
- MiniMax M2.5 Free is available on OpenAiCode for a limited time. The team is using this time to collect feedback and improve the model.
- MiMo V2 Flash Free is available on OpenAiCode for a limited time. The team is using this time to collect feedback and improve the model.
- Nemotron 3 Super Free is available on OpenAiCode for a limited time. The team is using this time to collect feedback and improve the model.
- Big Pickle is a stealth model that's free on OpenAiCode for a limited time. The team is using this time to collect feedback and improve the model.
...
4. Have **no lock-in** by allowing you to use it with any other coding agent. And always let you use any other provider with OpenAiCode as well.
