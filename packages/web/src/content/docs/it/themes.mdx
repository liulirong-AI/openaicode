...
Con OpenAiCode puoi scegliere tra diversi temi integrati, usare un tema che si adatta al tema del tuo terminale oppure definire un tema personalizzato.

Per impostazione predefinita, OpenAiCode usa il tema `opencode`.
...
OpenAiCode include diversi temi integrati.
...
- Vuole che OpenAiCode corrisponda all'aspetto del terminale
...
OpenAiCode supporta un sistema di temi flessibile basato su JSON che permette di creare e personalizzare temi facilmente.
