...
Le skill degli agenti permettono a OpenAiCode di individuare istruzioni riutilizzabili dal tuo repo o dalla home directory.
...
OpenAiCode cerca in queste posizioni:
...
Per i percorsi locali al progetto, OpenAiCode risale dalla directory di lavoro corrente finche' non raggiunge il worktree git.
...
OpenAiCode elenca le skill disponibili nella descrizione dello strumento `skill`.
