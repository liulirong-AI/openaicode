---
title: Server LSP
description: OpenAiCode si integra con i tuoi server LSP.
---

OpenAiCode si integra con il tuo Language Server Protocol (LSP) per aiutare l'LLM a interagire con la tua codebase. Usa le diagnostiche per fornire feedback all'LLM.

---

## Integrati

OpenAiCode include diversi server LSP integrati per linguaggi popolari:
