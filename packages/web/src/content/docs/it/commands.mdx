...
Puoi aggiungere comandi personalizzati tramite la config di OpenAiCode o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di OpenAiCode:
