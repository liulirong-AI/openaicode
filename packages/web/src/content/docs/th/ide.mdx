---
title: IDE
description: ส่วนขยาย OpenAiCode สำหรับ VS Code, Cursor และ IDE อื่นๆ
---

OpenAiCode ทำงานร่วมกับ VS Code, Cursor หรือ IDE ใดๆ ที่รองรับ terminal เพียงเรียกใช้ `opencode` ใน terminal เพื่อเริ่มต้น

---

## การใช้งาน

- **เปิดใช้ด่วน**: ใช้ `Cmd+Esc` (Mac) หรือ `Ctrl+Esc` (Windows/Linux) เพื่อเปิด OpenAiCode ในมุมมอง terminal แบบแยก หรือเน้นเซสชัน terminal ที่มีอยู่หากมีการทำงานอยู่แล้ว
- **เซสชันใหม่**: ใช้ `Cmd+Shift+Esc` (Mac) หรือ `Ctrl+Shift+Esc` (Windows/Linux) เพื่อเริ่มเซสชัน terminal OpenAiCode ใหม่ แม้ว่าเซสชันหนึ่งจะเปิดอยู่แล้วก็ตาม คุณยังสามารถคลิกปุ่ม OpenAiCode ใน UI ได้ด้วย
- **การรับรู้บริบท**: แชร์การเลือกหรือแท็บปัจจุบันของคุณโดยอัตโนมัติด้วย OpenAiCode
...
วิธีติดตั้ง OpenAiCode บน VS Code และทางแยกยอดนิยม เช่น Cursor, Windsurf, VSCodium:
...
ค้นหา **OpenAiCode** ใน Extension Marketplace แล้วคลิก **ติดตั้ง**
