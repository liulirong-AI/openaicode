...
description: OpenAiCode ทำงานร่วมกับเซิร์ฟเวอร์ LSP ของคุณ
---

OpenAiCode ทำงานร่วมกับ Language Server Protocol (LSP) เพื่อช่วยให้ LLM โต้ตอบกับโค้ดเบสของคุณ ใช้การวินิจฉัยเพื่อให้ข้อเสนอแนะไปยัง LLM

---

## บิวท์อิน

OpenAiCode มาพร้อมกับเซิร์ฟเวอร์ LSP ในตัวหลายตัวสำหรับภาษายอดนิยม:
