...
ด้วย OpenAiCode คุณสามารถเลือกจากหนึ่งในธีมที่มีอยู่แล้วภายใน ใช้ธีมที่ปรับให้เข้ากับธีม terminal ของคุณ หรือกำหนดธีมที่คุณกำหนดเองได้

ตามค่าเริ่มต้น OpenAiCode จะใช้ธีม `opencode` ของเราเอง
...
OpenAiCode มาพร้อมกับธีมในตัวหลายธีม
...
- ต้องการให้ OpenAiCode ตรงกับรูปลักษณ์ของ terminal
...
OpenAiCode รองรับระบบธีมที่ใช้ JSON ที่ยืดหยุ่น ซึ่งช่วยให้ผู้ใช้สามารถสร้างและปรับแต่งธีมได้อย่างง่ายดาย
