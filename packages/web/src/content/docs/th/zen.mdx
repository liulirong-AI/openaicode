---
title: เซน
description: รายการโมเดลที่คัดสรรโดย OpenAiCode
---
...
OpenAiCode Zen คือรายการโมเดลที่ได้รับการทดสอบและตรวจสอบแล้วโดยทีมงาน OpenAiCode

:::note
OpenAiCode Zen ปัจจุบันอยู่ในช่วงเบต้า
:::

Zen ทำงานเหมือนกับผู้ให้บริการรายอื่นๆ ใน OpenAiCode คุณเข้าสู่ระบบ OpenAiCode Zen และรับ
...
:::tip
เราได้ทดสอบกลุ่มโมเดลและผู้ให้บริการที่เลือกซึ่งทำงานได้ดีกับ OpenAiCode
:::
...
OpenAiCode Zen เป็นเกตเวย์ AI ที่ให้คุณเข้าถึงโมเดลเหล่านี้

---

## มันทำงานอย่างไร

OpenAiCode Zen ทำงานเหมือนกับผู้ให้บริการรายอื่นๆ ใน OpenAiCode

1. คุณลงชื่อเข้าใช้ **<a href={console}>OpenAiCode Zen</a>** เพิ่มการเรียกเก็บเงินของคุณ
   รายละเอียดและคัดลอกรหัส API ของคุณ
2. คุณรันคำสั่ง `/connect` ใน TUI เลือก OpenAiCode Zen และวางคีย์ API ของคุณ
...
[model id](/docs/config/#models) ในการกำหนดค่า OpenAiCode ของคุณ
...
- MiniMax M2.5 Free พร้อมใช้งานบน OpenAiCode ในระยะเวลาจำกัด ทีมงานใช้เวลานี้เพื่อรวบรวมคำติชมและปรับปรุงโมเดล
- Big Pickle เป็นโมเดลล่องหนที่ให้บริการฟรีบน OpenAiCode ในระยะเวลาจำกัด ทีมงานใช้เวลานี้เพื่อรวบรวมคำติชมและปรับปรุงโมเดล
...
4. **ไม่มีการล็อคอิน** โดยอนุญาตให้คุณใช้กับเอเจนต์การเขียนโค้ดอื่นๆ และให้คุณใช้ผู้ให้บริการรายอื่นกับ OpenAiCode ได้เช่นกัน
