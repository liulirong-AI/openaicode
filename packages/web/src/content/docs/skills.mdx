...
Agent skills let OpenAiCode discover reusable instructions from your repo or home directory.
...
OpenAiCode searches these locations:
...
For project-local paths, OpenAiCode walks up from your current working directory until it reaches the git worktree.
...
OpenAiCode lists available skills in the `skill` tool description.
