---
title: Zen
description: Kurirana lista modela koje nudi OpenAiCode.
---
...
OpenAiCode Zen je lista testiranih i provjerenih modela koje obezbjeduje OpenAiCode tim.

:::note
OpenAiCode Zen je trenutno u beta fazi.
:::

Zen radi kao i svaki drugi provajder u OpenAiCode. Prijavite se u OpenAiCode Zen i uzmete API kljuc. Ovo je **potpuno opcionalno** i ne morate ga koristiti da biste koristili OpenAiCode.
...
:::tip
Testirali smo odabranu grupu modela i provajdera koji dobro rade s OpenAiCode.
:::
...
OpenAiCode Zen je AI gateway koji vam daje pristup tim modelima.

---

## Kako radi

OpenAiCode Zen radi kao i svaki drugi provajder u OpenAiCode.

1. Prijavite se na **<a href={console}>OpenAiCode Zen</a>**, dodajte billing podatke i kopirajte API kljuc.
2. U TUI-ju pokrenite `/connect`, izaberite OpenAiCode Zen i zalijepite API kljuc.
...
[model id](/docs/config/#models) u OpenAiCode konfiguraciji koristi format `opencode/<model-id>`. Na primjer, za GPT 5.2 Codex u konfiguraciji koristite `opencode/gpt-5.2-codex`.
...
- MiniMax M2.5 Free je dostupan na OpenAiCode ograniceno vrijeme. Tim koristi taj period za prikupljanje povratnih informacija i poboljsanje modela.
- Big Pickle je stealth model koji je besplatan na OpenAiCode ograniceno vrijeme. Tim koristi taj period za prikupljanje povratnih informacija i poboljsanje modela.
...
OpenAiCode Zen smo napravili da:
...
4. Obezbijedimo **bez lock-ina** tako da Zen mozete koristiti sa bilo kojim coding agentom, uz slobodu koristenja drugih provajdera u OpenAiCode.
