...
OpenAiCode podržava standardne proxy varijable okruženja i prilagođene certifikate za enterprise mrežna okruženja.

## Proksi

OpenAiCode poštuje standardne varijable proxy okruženja.
...
Ako vaše preduzeće koristi prilagođene CA-ove za HTTPS veze, konfigurirajte OpenAiCode da im vjeruje.
