---
title: TUI
description: Korištenje korisničkog interfejsa OpenAiCode terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

OpenAiCode pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje OpenAiCode pokreće TUI za trenutni direktorij.
...
Kada koristite OpenAiCode TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u OpenAiCode. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz OpenAiCode. _Aliases_: `/quit`, `/q`
