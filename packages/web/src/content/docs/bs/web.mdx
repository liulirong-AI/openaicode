---
title: Web
description: Korišćenje OpenAiCode u vašem pretraživaču.
---

OpenAiCode može raditi kao web aplikacija u vašem pretraživaču, pružajući isto moćno iskustvo AI kodiranja bez potrebe za terminalom.

![OpenAiCode Web - Nova sesija](../../../assets/web/web-homepage-new-session.png)
...
Ovo pokreće lokalni server na `127.0.0.1` sa nasumičnim dostupnim portom i automatski otvara OpenAiCode u vašem podrazumevanom pretraživaču.
...
OpenAiCode podrazumevano bira dostupni port. Možete odrediti port:
...
Podrazumevano, server se vezuje za `127.0.0.1` (samo lokalni host). Da biste OpenAiCode učinili dostupnim na vašoj mreži:

```bash
opencode web --hostname 0.0.0.0
```

Kada koristite `0.0.0.0`, OpenAiCode će prikazati i lokalne i mrežne adrese:
...
Jednom pokrenut, web sučelje pruža pristup vašim OpenAiCode sesijama.

### Sesije

Pregledajte i upravljajte svojim sesijama sa početne stranice. Možete vidjeti aktivne sesije i započeti nove.

![OpenAiCode Web - aktivna sesija](../../../assets/web/web-homepage-active-session.png)

### Status servera

Kliknite "Pogledajte servere" da vidite povezane servere i njihov status.

![OpenAiCode Web - Vidi servere](../../../assets/web/web-homepage-see-servers.png)
