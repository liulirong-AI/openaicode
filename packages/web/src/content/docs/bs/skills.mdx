...
Agent skills omogucavaju OpenAiCode da pronade uputstva koja se mogu ponovo koristiti iz repozitorija ili home direktorija.
...
OpenAiCode pretrazuje ove lokacije:
...
Za projektne lokalne putanje, OpenAiCode ide prema gore od trenutnog radnog direktorija dok ne dode do git worktree-ja.
...
OpenAiCode navodi dostupne skills u opisu `skill` alata.
