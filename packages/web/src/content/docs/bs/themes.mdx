...
U OpenAiCode mozete birati izmedu vise ugradenih tema, koristiti temu koja se prilagodava terminalu ili definisati vlastitu temu.

Po defaultu, OpenAiCode koristi nasu `opencode` temu.
...
OpenAiCode dolazi sa vise ugradenih tema.
...
- Zele da OpenAiCode odgovara izgledu njihovog terminala
...
OpenAiCode podrzava fleksibilan sistem tema baziran na JSON-u koji olaksava kreiranje i prilagodavanje tema.
