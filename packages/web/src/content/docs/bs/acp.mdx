---
title: ACP podrška
description: Koristite OpenAiCode u bilo kojem uređivaču kompatibilnom sa ACP.
---

OpenAiCode podržava [Agent Client Protocol](https://agentclientprotocol.com) (ACP), što vam omogućava da ga koristite direktno u kompatibilnim uređivačima i IDE-ovima.
...
Da biste koristili OpenAiCode putem ACP-a, konfigurirajte svoj uređivač da pokrene naredbu `opencode acp`.

Naredba pokreće OpenAiCode kao ACP-kompatibilan podproces koji komunicira sa vašim uređivačem preko JSON-RPC-a kroz stdio.
...
Da biste ga otvorili, koristite novog "OpenAiCode" agenta u AI Chat agent selektoru.
...
Da koristite OpenAiCode kao ACP agenta u [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), dodajte sljedeće u svoju Neovim konfiguraciju:
...
Ova konfiguracija postavlja CodeCompanion da koristi OpenAiCode kao ACP chat agenta.
...
OpenAiCode radi isto kroz ACP kao i u terminalu. Podržane su sve funkcije:
...
- MCP serveri konfigurisani u vašoj OpenAiCode konfiguraciji
