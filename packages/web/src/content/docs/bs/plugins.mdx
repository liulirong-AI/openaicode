---
title: Dodaci
description: Napišite vlastite dodatke za proširenje OpenAiCode.
---

Dodaci vam omogućavaju da proširite OpenAiCode spajanjem na različite događaje i prilagođavanjem ponašanja. Možete kreirati dodatke za dodavanje novih funkcija, integraciju sa eksternim uslugama ili izmenu zadanog ponašanja OpenAiCode.
...
OpenAiCode pokreće `bun install` pri pokretanju da ih instalira. Vaši dodaci i alati ih zatim mogu uvesti.
...
Evo nekoliko primjera dodataka koje možete koristiti za proširenje OpenAiCode.
