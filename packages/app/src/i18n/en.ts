export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by OpenAiCode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in OpenAiCode.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "OpenAiCode Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in OpenAiCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in OpenAiCode.",
  ...
  "dialog.plugins.empty": "Plugins configured in openaicode.json",
  ...
  "dialog.server.description": "Switch which OpenAiCode server this app connects to.",
  ...
  "toast.update.description": "A new version of OpenAiCode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the OpenAiCode team",
  ...
  "error.chain.checkConfig": "Check your config (openaicode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, OpenAiCode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "OpenAiCode includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the OpenAiCode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for OpenAiCode",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how OpenAiCode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether OpenAiCode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how OpenAiCode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when OpenAiCode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of OpenAiCode.",
  ...
  "dashboard.noAgents": "No active agents",
  "dashboard.status.busy": "Busy",
  "dashboard.status.idle": "Idle",
  "dashboard.status.retry": "Retrying",
