export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par OpenAiCode",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans OpenAiCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "OpenAiCode Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.opencodeZen.visit.link": "openaicode.ai/zen",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans OpenAiCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans OpenAiCode.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans openaicode.json",
  ...
  "dialog.server.description": "Changez le serveur OpenAiCode auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version d'OpenAiCode ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe OpenAiCode",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (openaicode.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'OpenAiCode ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "OpenAiCode inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "app.name.desktop": "OpenAiCode Desktop",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur OpenAiCode dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour OpenAiCode",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'OpenAiCode sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si OpenAiCode suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'OpenAiCode.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'OpenAiCode",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'OpenAiCode.",
