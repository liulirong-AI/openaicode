...
export const dict = {
  ...
  "dialog.provider.opencode.note": "使用 OpenAiCode Zen 或 API 密钥连接",
  ...
  "dialog.model.unpaid.freeModels.title": "OpenAiCode 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 OpenAiCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.opencodeZen.line1": "OpenAiCode Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 OpenAiCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 并输入以下代码，以连接你的帐户并在 OpenAiCode 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 openaicode.json 中配置的插件",
  ...
  "dialog.server.description": "切换此应用连接的 OpenAiCode 服务器。",
  ...
  "toast.update.description": "OpenAiCode 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 OpenAiCode 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (openaicode.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: OpenAiCode 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "OpenAiCode 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 OpenAiCode 服务器。",
  ...
  "settings.general.row.language.description": "更改 OpenAiCode 的显示语言",
  "settings.general.row.appearance.title": "外观",
  "settings.general.row.appearance.description": "自定义 OpenAiCode 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 OpenAiCode 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 OpenAiCode 的主题。",
  ...
  "settings.updates.row.startup.description": "在 OpenAiCode 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 OpenAiCode。",
  ...
  "dashboard.idle": "空闲",
  "dashboard.kanban": "任务看板",
  "dashboard.active": "进行中",
  "dashboard.archived": "已归档",
  "dashboard.recentSessions": "最近会话",
  "dashboard.agentHealth": "智能体状态",
  "dashboard.noActive": "暂无进行中的会话",
  "dashboard.noAgents": "暂无活跃智能体",
  "dashboard.status.busy": "忙碌",
  "dashboard.status.idle": "空闲",
  "dashboard.status.retry": "重试中",
