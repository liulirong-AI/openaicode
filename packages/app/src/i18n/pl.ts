export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez OpenAiCode",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w OpenAiCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "OpenAiCode Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w OpenAiCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w OpenAiCode.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w openaicode.json",
  ...
  "dialog.server.description": "Przełącz serwer OpenAiCode, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja OpenAiCode ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu OpenAiCode",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (openaicode.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "OpenAiCode zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla OpenAiCode",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd OpenAiCode na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy OpenAiCode ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw OpenAiCode.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania OpenAiCode",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji OpenAiCode.",
