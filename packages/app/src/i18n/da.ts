export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af OpenAiCode",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i OpenAiCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "OpenAiCode Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i OpenAiCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i OpenAiCode.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i openaicode.json",
  ...
  "dialog.server.description": "Skift hvilken OpenAiCode-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af OpenAiCode ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til OpenAiCode-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (openaicode.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, OpenAiCode understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "OpenAiCode inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør OpenAiCode-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for OpenAiCode",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan OpenAiCode ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om OpenAiCode følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan OpenAiCode er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når OpenAiCode starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af OpenAiCode.",
