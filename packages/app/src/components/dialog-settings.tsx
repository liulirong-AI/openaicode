...
export const DialogSettings: Component<{ initialTab?: string }> = (props) => {
  ...
  const [defaultValue] = createSignal(props.initialTab ?? "general")

  return (
    <Dialog size="x-large" transition>
      <Tabs orientation="vertical" variant="settings" defaultValue={defaultValue()} class="h-full settings-dialog">
        <Tabs.List>
