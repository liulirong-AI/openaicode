...
export default function TermsOfService() {
  ...
  return (
    <main data-page="legal">
      <Title>OpenAiCode | Terms of Service</Title>
      <LocaleLinks path="/legal/terms-of-service" />
      <Meta name="description" content="OpenAiCode terms of service" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="terms-of-service">
              ...
              <p>
                Welcome to OpenAiCode. Please read on to learn the rules and restrictions that govern your use of
                OpenAiCode&apos;s website, inference product and hosted software offering (the "Services"). If you have
              ...
              <p>
                ...
                <strong>ANOMALY INNOVATIONS, INC.</strong> ("OpenAiCode," "we" and "us"). Your use of the Services in any
              ...
              <h2 id="what-is-opencode">What is OpenAiCode?</h2>
              <p>
                OpenAiCode is an AI-powered coding agent that helps you write, understand, and modify code using large
                language models. Certain of these large language models are provided by third parties ("Third Party
                Models") and certain of these models are provided directly by us if you use the OpenAiCode Zen paid
                offering ("Zen"). Regardless of whether you use Third Party Models or Zen, OpenAiCode enables you to
              ...
              <p>
                OpenAiCode takes the privacy of its users very seriously. For the current OpenAiCode Privacy Policy, please
                click here{" "}
              ...
              <h2 id="what-are-the-basics">What are the basics of using OpenAiCode?</h2>
              <p>
              ...
              <ol style="list-style-type: lower-alpha;">
                ...
                <li>
                  ...
                  privacy laws or any other purpose not reasonably intended by OpenAiCode;
                </li>
                <li>
              ...
              <p>
                If you use OpenAiCode with Third Party Models, then your Content will be subject to the data retention
              ...
              <p>
                ...
                OpenAiCode. Your ability to access Third Party Models is contingent on you having API keys or otherwise
                having the right to access such Third Party Models.
              </p>

              <p>
                OpenAiCode has no control over, and assumes no responsibility for, the content, accuracy, privacy
              ...
              <h2 id="will-opencode-ever-change-the-services">Will OpenAiCode ever change the Services?</h2>
              <p>
              ...
              <p>
                OpenAiCode is also free to terminate (or suspend access to) your use of the Services for any reason in our
                discretion, including your breach of these Terms. OpenAiCode has the sole right to decide whether you are
              ...
              <p>
                OpenAiCode and its licensors, suppliers, partners, parent, subsidiaries or affiliated entities, and each
                of their respective officers, directors, members, employees, consultants, contract employees,
                representatives and agents, and each of their respective successors and assigns (OpenAiCode and all such
                parties together, the "OpenAiCode Parties") make no representations or warranties concerning the Services,
                including without limitation regarding any Content contained in or accessed through the Services, and
                the OpenAiCode Parties will not be responsible or liable for the accuracy, copyright compliance, legality,
                ...
                participation in, the Services. The OpenAiCode Parties make no representations or warranties regarding
              ...
              <h3>Indemnity</h3>
              <p>
                You agree to indemnify and hold the OpenAiCode Parties harmless from and against any and all claims,
              ...
              <p>
                ...
                Services account, in any way (by operation of law or otherwise) without OpenAiCode's prior written
              ...
              <p>
                ...
                disputes and claims with OpenAiCode and limits the manner in which you can seek relief from OpenAiCode. Both
                you and OpenAiCode acknowledge and agree that for the purposes of any dispute arising out of or relating
                to the subject matter of these Terms, OpenAiCode's officers, directors, employees and independent
              ...
              <p>
                The Rules will govern payment of all arbitration fees. OpenAiCode will pay all arbitration fees for claims
                less than seventy-five thousand ($75,000) dollars. OpenAiCode will not seek its attorneys' fees and costs
                in arbitration unless the arbitrator determines that your claim is frivolous.
              </p>

              <h4>Small Claims Court; Infringement</h4>
              <p>
                Either you or OpenAiCode may assert claims, if they qualify, in small claims court in New Castle County,
              ...
              <p>
                ...
                OF A JUDGE OR JURY. You and OpenAiCode are instead choosing to have claims and disputes resolved by
                ...
                you and OpenAiCode over whether to vacate or enforce an arbitration award, YOU AND OPENCODE WAIVE ALL
              ...
              <p>
                ...
                OpenAiCode is entitled to arbitration; instead all claims and disputes will be resolved in a court as set
                forth in (g) below.
              </p>
              ...
              <p>
                ...
                agreement permits either you or OpenAiCode to litigate any dispute arising out of or relating to the
                subject matter of these Terms in court, then the foregoing arbitration agreement will not apply to
                either party, and both you and OpenAiCode agree that any judicial proceeding (other than small claims
              ...
              <p>
                ...
                the OpenAiCode may, in its sole discretion, do any of the foregoing on your behalf or for itself as it
                ...
                Terms shall otherwise remain in full force and effect and enforceable. You and OpenAiCode agree that these
                Terms are the complete and exclusive statement of the mutual understanding between you and OpenAiCode, and
                ...
                are not an employee, agent, partner, or joint venture of OpenAiCode, and you do not have any authority of
                any kind to bind OpenAiCode in any respect whatsoever.
              </p>

              <p>
                Except as expressly set forth in the section above regarding the arbitration agreement, you and OpenAiCode
