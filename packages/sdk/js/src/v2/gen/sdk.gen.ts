...
export class Config extends HeyApiClient {
   ...
   *
   * Retrieve the current global OpenAiCode configuration settings and preferences.
   */
   ...
   *
   * Update global OpenAiCode configuration settings and preferences.
   */
...
export class Global extends HeyApiClient {
   ...
   * Get health
   *
   * Get health information about the OpenAiCode server.
   */
   ...
   * Get global events
   *
   * Subscribe to global events from the OpenAiCode system using server-sent events.
   */
   ...
   * Dispose instance
   *
   * Clean up and dispose all OpenAiCode instances, releasing all resources.
   */
...
export class Project extends HeyApiClient {
   ...
   * List all projects
   *
   * Get a list of projects that have been opened with OpenAiCode.
   */
   ...
   * Get current project
   *
   * Retrieve the currently active project that OpenAiCode is working with.
   */
...
export class Pty extends HeyApiClient {
   ...
   * List PTY sessions
   *
   * Get a list of all active pseudo-terminal (PTY) sessions managed by OpenAiCode.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Config2 extends HeyApiClient {
   ...
   * Get configuration
   *
   * Retrieve the current OpenAiCode configuration settings and preferences.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   *
   * Update OpenAiCode configuration settings and preferences.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Session2 extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all OpenAiCode sessions, sorted by most recently updated.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Create session
   *
   * Create a new OpenAiCode session for interacting with AI assistants and managing conversations.
   */
  public create<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get session
   *
   * Retrieve detailed information about a specific OpenAiCode session.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
...
export class Instance extends HeyApiClient {
   ...
   * Dispose instance
   *
   * Clean up and dispose the current OpenAiCode instance, releasing all resources.
   */
...
export class Command extends HeyApiClient {
   ...
   * List commands
   *
   * Get a list of all available commands in the OpenAiCode system.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class App extends HeyApiClient {
   ...
   * List agents
   *
   * Get a list of all available AI agents in the OpenAiCode system.
   */
   ...
   * List skills
   *
   * Get a list of all available skills in the OpenAiCode system.
   */
